...
for _key, _questions in QUESTION_BANKS.items():
    _category, _difficulty = _key
    SEED_QUESTIONS.extend((_category, _difficulty, q, o, a) for q, o, a in _questions)

for _key, _questions in QUALITY_BANKS.items():
    _category, _difficulty = _key
    SEED_QUESTIONS.extend((_category, _difficulty, q, o, a) for q, o, a in _questions)
